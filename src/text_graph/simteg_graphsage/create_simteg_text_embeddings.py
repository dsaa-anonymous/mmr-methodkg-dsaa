...
from path_utils import default_simteg_text_embeddings, discover_awards, discover_benchmark, find_repo_root, read_csv_or_zip, reset_dir_if_overwrite, resolve_existing_path, resolve_output_path, write_resolved_paths
...
def main() -> None:
    ...
    parser.add_argument("--outdir", default=None, help="Output directory. Defaults to artifacts/features/simteg_text_embeddings_scibert_v1")
    ...
    outdir = resolve_output_path(args.outdir, repo_root, default_simteg_text_embeddings(repo_root).parent)
